...
const steps = [
  {
    ...
    element: (
      <p className="whitespace-pre-line">
        {`Welcome to the first session of our relaxation and visualization program. In this session, we will guide you through various methods to induce relaxation so that you can choose the one that resonates with you the most. It is our belief that anyone can acquire the skills of relaxation and meditation, given appropriate guidance and practice. These techniques can be of great benefit to individuals to seeking to improve their psychological well-being, reduce stress and anxiety, and enhance their overall quality of life. Indeed, more complex tasks such as visualization and self-suggestion can be highly effective when one is able to reach a state of peaceful relaxation. Through focused attention and the power of suggestion, individuals can learn to tap into the deeper resources of their own subconscious minds, unlocking their potential for personal growth and transformation. ✨

But it is important to remember that these skills require patience and practice, and that progress may come gradually over time. With the right mindset, however, anyone can learn to master the art of relaxation and meditation, unlocking the full potential of their own inner resources and achieving a greater sense of well-being and fulfillment in their lives. Just by doing these short exercises day by day, you will be able to handle stress much better in your life, and feel more at ease.

First, find a quiet and peaceful place... It could be a room in your home or a serene outdoor space... The important thing is that it feels soothing to you... You don't need to eliminate all sounds, but choose a place where you can be comfortable and feel safe. Once you've found your spot, get into a comfortable position... You may want to lie down on your back or find a comfortable chair to sit in... Whatever position you choose, make sure you feel relaxed and at ease. Now that you're comfortable, let's explore different relaxation techniques. There are various methods that you can use to induce relaxation. One common technique is to focus on your breathing. Let's try this now. You can start by taking a deep breath in through your nose (3 seconds) and exhaling slowly through your mouth (4 seconds). Pay attention to your breath, and let your body relax with each exhale... Another technique is to focus on your body and relax your muscles systematically. You may start with your feet and work your way up to your head. You can also try repeating a word or phrase that reminds you of a peaceful place or feeling. This technique is called a mantra, and it can help you quiet your mind and focus on relaxation. In addition to these, you will be introduced to a number of other techniques during the programme. 🌟

During our program, we will guide you through all of these techniques so that you can choose the one that resonates with you the most or combine them. Remember, this is your time to relax and unwind, so choose the method that feels most comfortable to you. I hope this session has provided you with a solid foundation for exploring the practice of relaxation and meditation. Remember, the key to success is consistent practice and a willingness to be patient with yourself as you develop these skills. 
...
Enjoy the journey of self-discovery and personal growth as you explore the depths of relaxation and inner peace! ⭐️`}
  ...
  },
  {
    ...
    element: (
      <VideoWatchStep src="https://youtu.be/UvfmeLGPi_M" />
    ),
  },
  {
    ...
    It is recommended that you wait 2-3 days between modules and only then continue practising. But if you want, you can of course practice these techniques every day by returning to the videos again!`,
    element: null,
  },
  {
    label: "Relaxation self coach: II. module",
    element: (
      <VideoWatchStep src="https://youtu.be/5KniEQ3gxM0" />
    ),
  },
  {
